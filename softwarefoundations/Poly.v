...
Proof.
  ...
  induction v as [| h v'].
    simpl. reflexivity.
    simpl. rewrite -> IHv'. simpl. reflexivity.  Qed.
...
Proof.
  intros X l1 l2 v. induction l1 as [| h l1'].
    simpl. reflexivity.
...
Theorem map_snoc : forall (X Y : Type) (f : X -> Y) (v : X) (l : list X),
...
Proof.
  intros m. induction m as [| m'].
    ...
    destruct n as [| n'].
      ...
      simpl. intros H. apply eq_remove_S. apply IHm'. apply H.  Qed.
(** [] *)
...
Proof.
  destruct n.
    simpl. reflexivity.
    simpl. intros contra. inversion contra.  Qed.
...
Proof.
  ...
  remember (beq_nat k1 k2) as eq.
    destruct eq.
      rewrite <- H. apply beq_nat_eq in Heqeq. rewrite -> Heqeq. reflexivity.
      reflexivity.
Qed.
(** [] *)

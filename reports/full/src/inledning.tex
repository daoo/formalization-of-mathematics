...
appendix~\ref{sec:algebra}.}, där man multiplicerar varje term i det
...
generell verision av \toom -algoritmen för multiplikation av polynom.
Detta skall göras i \coq som är en interaktiv bevisassistent. 

...
implementerades i avsnitt~\ref{sec:formell} är generell och på abstrakt
vilket är bra då den ska bevisas. Med vår implementation kan inga beräkningar
utföras då typen av polynom i \ssr{} är låst, se avsnitt~\ref{sec:ssr}. Om
...
I evalueringssteget~\ref{sec:evaluation} i algoritmen multipliceras
...
I interpolationssteget~\ref{sec:interpol} antas det att interpolationsmatrisen

...
uppdelningsfunktion \C{split} är högerinvers till sammansättningsfunktionen \C{recompose} under vissa förutsättningar.
...
att vi har implementerat uppdelningen, \C{split}, med polynomdivision och
...
som den ursprungliga \C{split}-definitionen. Vi hann dock inte testa om detta var en effektivare definition.

...
Nedan finns två funktionsdefinitioner där beroendetypning används. I exemplena
används en klass som heter Vector och det är inget mer komplicerat en lista med
fast längd. I det första exemplet så gör vi om en lista till en vektor och
vektorn ska då ha samma längd som listan. I det andra exemplet har vi en
funktion som tar bort det första ellementet från en vektor och resultatet blir
då en vector med ett mindre ellement.
\begin{verbatim}
...
deras typer på värdet av den första parametern. Här bestäms antalet parametrar
på antalet \% i den första strängen och vilken typ det ska vara på dessa
